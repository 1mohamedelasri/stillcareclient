...
export class UnitListComponent {
  ...
  unites: IUnit[] = [
    { id: '1', name: 'Unité 1', status: UnitStatus.COVID,   desc: 'The best 1 unit of the world', personnels: [{ surname: 'personnel2', name: 'prenom1', img: '../../../..//assets/img/avatars/default.png', function: 'certaine fonction', mail: 'mail@mail.com' }, { surname: 'personnel3', name: 'prenom1', img: '../../../../assets/content/doctor-400-3.jpg', function: 'certaine fonction', mail: 'mail@mail.com' }] },
