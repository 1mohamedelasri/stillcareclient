...
export const PersonnelNavItems: INavData[] = [
  ...
  { title: true, name: 'Espace du personnel' },
  {
  ...
  {
    name: 'Gérer contacts', url: '/personnel/contact/valider', icon: 'cil-group'
  },
  {
    ...
    children: [
      ...
      { name: 'Créneaux libres', url: '/personnel/calendrier/creneau-libre', icon: 'cil-calendar' },
    ]
  },
  {
...
export const DirectionNavItems: INavData[] = [
  ...
  { title: true, name: 'Espace de la direction' },
  {
...
export const ContactNavItems: INavData[] = [
  ...
  { title: true, name: 'Espace du contact' },
  {
